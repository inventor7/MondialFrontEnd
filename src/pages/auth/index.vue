<template>
    <ClientLayout>
        ...
        <div class=" flex flex-col justify-center items-center w-full  h-[90vh]   px-4 ">
            ...
            <div class=" flex flex-col justify-start items-center w-full h-fit max-w-lg space-y-10  ">
                <svg class=" w-20 h-20  lg:w-24 lg:h-24 " viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
